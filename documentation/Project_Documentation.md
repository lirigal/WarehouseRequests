...
2. [Chapter 2: Application Architecture](#chapter-2)
3. [Chapter 3: Database Documentation](#chapter-3)
4. [Chapter 4: Solution & Code Structure](#chapter-4)
5. [Chapter 5: Business Logic & Request Lifecycle](#chapter-5)
6. [Chapter 6: Authentication & Security](#chapter-6)
7. [Chapter 7: User Manual - End User Guide](#chapter-7)
8. [Chapter 8: User Manual - Administrator Guide](#chapter-8)
9. [Chapter 9: Troubleshooting & Support](#chapter-9)
...
The system's structural integrity is maintained via a highly relational schema. Below is the full description of all 8 database tables.
...
<a name="chapter-4"></a>
# Chapter 4: Solution & Code Structure

### 4.1 Solution Layout Overview
...
<a name="chapter-5"></a>
# Chapter 5: Business Logic & Request Lifecycle

The system guarantees logistical consistency by enforcing strict business flows across multiple logical operations.
...
<a name="chapter-7"></a>
# Chapter 7: User Manual - End User Guide
...
<a name="chapter-8"></a>
# Chapter 8: User Manual - Administrator Guide
