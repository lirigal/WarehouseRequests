...
המערכת מספקת מגוון רחב של יכולות לניהול מלא של מחסן ארגוני, החל מניהול קטלוג הפריטים ועד לניפוק ציוד, בקרת מלאי, ניהול הרשאות ותיעוד מלא של כל פעולה.
...
```mermaid
(השאירו כאן את תרשים Mermaid המקורי ללא שינוי)
```
